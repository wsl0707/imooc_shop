                                    ...
                                    <li class="yamm-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="dropdown-banner-holder">
                                                <a href="#"><img alt="" src="statics/images/banners/banner-side.png" /></a>
                                            </div>
                                        </div>
                                        <!-- ================================== MEGAMENU VERTICAL ================================== -->
                                    </li>
            ...
            <div class="col-xs-12 col-sm-8 col-md-9 homebanner-holder">
                ...
                <div id="hero">
                    <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                        ...
                        <div class="item" style="background-image: url(statics/images/sliders/slider03.jpg);">
                            <div class="container-fluid">
                                <div class="caption vertical-center text-left">
                                    <div class="big-text fadeInDown-1">
                        ...
                        <div class="product-grid-holder">
                            <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="image">
                                        <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-01.jpg" />
                                    </div>
                                    <div class="body">
                            ...
                            <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="image">
                                        <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-02.jpg" />
                                    </div>
                                    <div class="body">
                            ...
                            <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="image">
                                        <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-03.jpg" />
                                    </div>
                                    <div class="body">
                                        <div class="label-discount clear"></div>
                                        <div class="title">
                            ...
                            <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="image">
                                        <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-04.jpg" />
                                    </div>
                                    <div class="body">
                                        <div class="label-discount clear"></div>
                                        <div class="title">
                ...
                <div class="col-xs-12 col-md-7 no-margin">
                    ...
                    <div class="row no-margin">
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-05.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-06.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-07.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                    ...
                    <div class="row no-margin">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-08.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-09.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-10.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                ...
                <div class="col-xs-12 col-md-5 no-margin">
                    <div class="product-item-holder size-big single-product-gallery small-gallery">
                        ...
                        <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel">
                            <div class="single-product-gallery-item" id="slide1">
                                <a data-rel="prettyphoto" href="images/products/product-gallery-01.jpg">
                                    <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-gallery-01.jpg" />
                                </a>
                        ...
                        <div class="gallery-thumbs clearfix">
                            <ul>
                                <li><a class="horizontal-thumb active" data-target="#best-seller-single-product-slider" data-slide="0" href="#slide1"><img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/gallery-thumb-01.jpg" /></a></li>
                                <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="1" href="#slide2"><img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/gallery-thumb-01.jpg" /></a></li>
                                <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="2" href="#slide3"><img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/gallery-thumb-01.jpg" /></a></li>
                            </ul>
                        </div><!-- /.gallery-thumbs -->
                ...
                <div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
                    <div class="no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            <div class="ribbon red"><span>sale</span></div>
                            <div class="image">
                                <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-11.jpg" />
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class="no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            <div class="ribbon blue"><span>new!</span></div>
                            <div class="image">
                                <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-12.jpg" />
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-13.jpg" />
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            <div class="ribbon blue"><span>new!</span></div>
                            <div class="image">
                                <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-14.jpg" />
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            <div class="ribbon green"><span>bestseller</span></div>
                            <div class="image">
                                <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-15.jpg" />
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-16.jpg" />
                            </div>
                            <div class="body">
                                <div class="title">
