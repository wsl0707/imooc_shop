                    ...
                    <div id="owl-single-product">
                        <div class="single-product-gallery-item" id="slide1">
                            <a data-rel="prettyphoto" href="images/products/product-gallery-01.jpg">
                                <img class="img-responsive" alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-gallery-01.jpg" />
                            </a>
                    ...
                    <div class="single-product-gallery-thumbs gallery-thumbs">
                        ...
                        <div id="owl-single-product-thumbnails">
                            <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="0" href="#slide1">
                                <img width="67" alt="" src="statics/images/blank.gif" data-echo="statics/images/products/gallery-thumb-01.jpg" />
                            </a>
                            ...
                            <div class="comment-item">
                                <div class="row no-margin">
                                    <div class="col-lg-1 col-xs-12 col-sm-2 no-margin">
                                        <div class="avatar">
                                            <img alt="avatar" src="statics/images/default-avatar.jpg">
                                        </div><!-- /.avatar -->
                                    </div><!-- /.col -->
