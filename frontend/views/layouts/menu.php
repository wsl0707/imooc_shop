...
<head>
    ...
    <link rel="stylesheet" href="statics/css/green.css">
    ...
    <link rel="stylesheet" href="statics/css/config.css">

    <link href="statics/css/green.css" rel="alternate stylesheet" title="Green color">
    <link href="statics/css/blue.css" rel="alternate stylesheet" title="Blue color">
    <link href="statics/css/red.css" rel="alternate stylesheet" title="Red color">
    <link href="statics/css/orange.css" rel="alternate stylesheet" title="Orange color">
    <link href="statics/css/navy.css" rel="alternate stylesheet" title="Navy color">
    <link href="statics/css/dark-green.css" rel="alternate stylesheet" title="Darkgreen color">
                ...
                <ul>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="商品列表页.html">Category - Grid/List</a></li>
    ...
    <header class="no-padding-bottom header-alt">
        <div class="container no-padding">
            ...
            <div class="col-xs-12 col-md-3 logo-holder">
                ...
                <div class="logo">
                    <a href="home.html">
                        <!--<img alt="logo" src="statics/images/logo.svg" width="233" height="54"/>-->
                        <!--<object id="sp" type="image/svg+xml" data="statics/images/logo.svg" width="233" height="54"></object>-->
                        ...
                        <div class="control-group">
                            ...
                            <ul class="categories-filter animate-dropdown">
                                <li class="dropdown">
                                    ...
                                    <a class="dropdown-toggle"  data-toggle="dropdown" href="商品列表页.html">all categories</a>

                                    <ul class="dropdown-menu" role="menu" >
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="商品列表页.html">laptops</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="商品列表页.html">tv & audio</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="商品列表页.html">gadgets</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="商品列表页.html">cameras</a></li>
                                    ...
                                    <div class="basket-item">
                                        <div class="row">
                                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                                <div class="thumb">
                                                    <img alt="" src="statics/images/products/product-small-01.jpg" />
                                                </div>
                                            </div>
                        ...
                        <ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-small-01.jpg" />
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-small-02.jpg" />
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-small-03.jpg" />
                                        </a>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul>
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-small-04.jpg" />
                                        </a>
                                    </div>
                                </div>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-small-05.jpg" />
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-small-06.jpg" />
                                        </a>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul>
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-small-07.jpg" />
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-small-08.jpg" />
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="statics/images/blank.gif" data-echo="statics/images/products/product-small-09.jpg" />
                                        </a>
                                    </div>
            ...
            <div class="col-xs-12 col-md-8 no-margin">
                ...
                <div class="link-widget">
                    <div class="widget">
                        <h3>Find it fast</h3>
                        <ul>
                            <li><a href="商品列表页.html">laptops &amp; computers</a></li>
                            <li><a href="商品列表页.html">Cameras &amp; Photography</a></li>
                            <li><a href="商品列表页.html">Smart Phones &amp; Tablets</a></li>
                            <li><a href="商品列表页.html">Video Games &amp; Consoles</a></li>
                            <li><a href="商品列表页.html">TV &amp; Audio</a></li>
                            <li><a href="商品列表页.html">Gadgets</a></li>
                            <li><a href="商品列表页.html">Car Electronic &amp; GPS</a></li>
                            <li><a href="商品列表页.html">Accesories</a></li>
                        </ul>
                    </div><!-- /.widget -->
                </div><!-- /.link-widget -->
                ...
                <div class="link-widget">
                    <div class="widget">
                        <h3>Information</h3>
                        <ul>
                            <li><a href="商品列表页.html">Find a Store</a></li>
                            <li><a href="商品列表页.html">About Us</a></li>
                            <li><a href="商品列表页.html">Contact Us</a></li>
                            <li><a href="商品列表页.html">Weekly Deals</a></li>
                            <li><a href="商品列表页.html">Gift Cards</a></li>
                            <li><a href="商品列表页.html">Recycling Program</a></li>
                            <li><a href="商品列表页.html">Community</a></li>
                            <li><a href="商品列表页.html">Careers</a></li>
                ...
                <div class="link-widget">
                    <div class="widget">
                        <h3>Information</h3>
                        <ul>
                            <li><a href="商品列表页.html">My Account</a></li>
                            <li><a href="商品列表页.html">Order Tracking</a></li>
                            <li><a href="商品列表页.html">Wish List</a></li>
                            <li><a href="商品列表页.html">Customer Service</a></li>
                            <li><a href="商品列表页.html">Returns / Exchange</a></li>
                            <li><a href="商品列表页.html">FAQs</a></li>
                            <li><a href="商品列表页.html">Product Support</a></li>
                            <li><a href="商品列表页.html">Extended Service Plans</a></li>
                        </ul>
                    </div><!-- /.widget -->
                </div><!-- /.link-widget -->
...
<script src="statics/js/switchstylesheet.js"></script>
